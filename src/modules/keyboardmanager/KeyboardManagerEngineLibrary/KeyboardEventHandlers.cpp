...
namespace
{
    ...
    /**
    * @returns True if the event is NOT from a physical keyboard press (injected/system-generated).
    */
    bool IsInjectedKeyboardEvent(const LowlevelKeyboardEvent* data)
    {
        return data->lParam->flags & LLKHF_INJECTED;
    }
...
namespace KeyboardEventHandlers
{
    ...
    {
        // Check if the key event was generated by KeyboardManager to avoid remapping events generated by us; also check if the event is an injected event from other software or the system to avoid remapping events like Ctrl-Insert.
        if (!GeneratedByKBM(data) && !IsInjectedKeyboardEvent(data))
        {
